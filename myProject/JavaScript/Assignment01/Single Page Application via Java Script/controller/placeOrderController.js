...
function addToCart(){
    ...
    cartDB.push(new cart(itemCode1,itemName1,orderQty1,itemPrice1,total));
...
function loadAllCartTable(){
    $("#cartTable").empty();
      for(var i of cartDB){
        ...
        <button type="button" class="btn-sm border btn-danger deleteCart" style="background-color: red;"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
               width="20" height="20"
               viewBox="0 0 172 172"
